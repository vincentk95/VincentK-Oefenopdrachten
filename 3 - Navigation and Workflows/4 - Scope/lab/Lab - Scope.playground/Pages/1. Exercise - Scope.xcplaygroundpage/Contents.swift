...
// foo has only been declared in the for-loop, so for the now-uncommented print statement it is out of scope
...
// because x has been declared in a global scope. Foo is only defined in the for-loop
/*:
...
greeting(greeting: "Waddup", name: "bro")
greeting(greeting: nil, name: "Aunt Ursela")
/*:
