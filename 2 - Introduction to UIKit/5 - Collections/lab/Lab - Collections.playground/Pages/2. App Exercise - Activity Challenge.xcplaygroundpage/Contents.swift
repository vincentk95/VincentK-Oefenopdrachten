 ...
 */
var walkChallenges: [String] = ["walk to supermarket to buy drinks", "walk the dog"]
var runChallenges: [String] = ["run away from responsibilites", "run to Thailand to enjoy beach"]
