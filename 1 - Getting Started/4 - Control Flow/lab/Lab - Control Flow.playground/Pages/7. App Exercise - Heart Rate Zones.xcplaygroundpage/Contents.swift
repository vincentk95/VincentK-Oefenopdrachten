...
switch (currentHR) {
case 100..<121: print("You are in the Very Light zone")
case 121..<141: print("You are in the Light zone")
case 141..<161: print ("You are in the Moderate zone")
case 161..<181: print("You are in the Hard zone")
case 181..<201: print("You are in the Maximum zone")
default: print("Slow down you gon die")
}
